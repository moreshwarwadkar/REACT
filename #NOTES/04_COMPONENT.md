...
- A `class ComponentA` : Here We can give any name to the class.</br>
- A `export default ComponentA` : This is Important Line. This will export data. By using this we can access this class in another file.
</br></br>
